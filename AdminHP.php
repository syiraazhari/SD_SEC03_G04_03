          ...
          <nav class="navbar navbar-expand-lg px-0 py-4">
            ...
            <div class="collapse navbar-collapse text-center" id="navbarsExample09">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item @@project"><a class="nav-link" href="project.html">ORDER</a></li>
				<li class="nav-item @@contact"><a class="nav-link" href="contact.html">MATERIAL</a></li>
				 ...
				 <li class="nav-item @@contact"><a class="nav-link" href="viewProfileAdmin.php">PROFILE</a></li>
              </ul>
		...
		<div class="row">
			<div class="col-lg-9 col-md-10">
				<div class="block">
					...
					<h1 class="animated fadeInUp mb-5">AVANTGARDE<br>MATH CLINIC <br>WEB</h1>
		...
		<div class="row ">
			<div class="col-lg-8">
				<div class="section-title">
					<span class="h6 text-color ">You are admin of the best online tuition in maths</span>
