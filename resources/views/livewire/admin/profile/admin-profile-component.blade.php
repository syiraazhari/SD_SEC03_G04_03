    ...
    <div class="container position-relative">
        <div class="row gy-5" data-aos="fade-in">
            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
                <h2><span>Administrator Profile</span></h2>
                <p>Edit Your Admin Profile.</p>
            </div>
        </div>
    </div>
            ...
            <div class="row gx-lg-0 gy-4">
                ...
                <div class="col-lg-8">
                    <form class="php-email-form" wire:submit.prevent="updateProfile">
                        ...
                        <!-- Email Form -->
                        <div class="form-group mt-3">
                            <input type="email" class="form-control" name="email" id="email" placeholder="{{ $admin->email }}" disabled required>
                        </div>
                        <!-- Phone Form -->
                        <div class="form-group mt-3">
                        ...
                        <div class="form-group mt-3">
                            <input type="text" class="form-control" name="ic" id="ic" placeholder="Your Identification Card" required wire:model="ic">
                        </div>
                        <!-- Age Form -->
                        <div class="form-group mt-3">
