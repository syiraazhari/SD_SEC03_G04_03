                                            ...
                                            <tbody>
                                                @foreach ($mondays as $monday)
                                                    <tr>
                                                        ...
                                                        <td>{{ $monday->tutor }}</td>
                                                        <td><a href="#" wire:click.prevent="deleteSchedule({{$monday->id}})">Delete</a></td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                @foreach ($tuesdays as $tuesday)
                                                    <tr>
                                                        ...
                                                        <td>{{ $tuesday->tutor }}</td>
                                                        <td><a href="#" wire:click.prevent="deleteSchedule({{$tuesday->id}})">Delete</a></td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                @foreach ($wednesdays as $wednesday)
                                                    <tr>
                                                        ...
                                                        <td><a href="#" wire:click.prevent="deleteSchedule({{$wednesday->id}})">Delete</a></td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                @foreach ($thursdays as $thursday)
                                                    <tr>
                                                        ...
                                                        <td><a href="#" wire:click.prevent="deleteSchedule({{$thursday->id}})">Delete</a></td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                @foreach ($fridays as $friday)
                                                    <tr>
                                                        ...
                                                        <td>{{ $friday->tutor }}</td>
                                                        <td><a href="#" wire:click.prevent="deleteSchedule({{$friday->id}})">Delete</a></td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                @foreach ($saturdays as $saturday)
                                                    <tr>
                                                        ...
                                                        <td><a href="#" wire:click.prevent="deleteSchedule({{$saturday->id}})">Delete</a></td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                @foreach ($sundays as $sunday)
                                                    <tr>
                                                        ...
                                                        <td>{{ $sunday->tutor }}</td>
                                                        <td><a href="#" wire:click.prevent="deleteSchedule({{$sunday->id}})">Delete</a></td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
