          ...
          <nav class="navbar navbar-expand-lg px-0 py-4">
            ...
            <div class="collapse navbar-collapse text-center" id="navbarsExample09">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item @@service"><a class="nav-link" href="service.html">SUBSCRIPTION</a></li>
                <li class="nav-item @@project"><a class="nav-link" href="project.html">TUTOR</a></li>
				<li class="nav-item @@contact"><a class="nav-link" href="contact.html">SHOP</a></li>
				 <li class="nav-item @@contact"><a class="nav-link" href="contact.html">CONTACT US</a></li>
              </ul>
      
              <div class="my-2 my-md-0 ml-lg-4 text-center">
			   <li class="btn btn-solid-border btn-round-full nav-item dropdown @@about">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdown03">
                    <li><a class="dropdown-item" href="Student\phploginstudent\loginUserFE.php">STUDENT</a></li>
                    <li><a class="dropdown-item" href="Tutor\phplogintutor\loginUserFE.php">TUTOR</a></li>
                <li><a class="dropdown-item" href="Admin\phploginadmin\loginUserFE.php">ADMIN</a></li>
              </div>
		...
		<div class="row">
			<div class="col-lg-9 col-md-10">
				<div class="block">
					...
					<h1 class="animated fadeInUp mb-5">AVANTGARDE MATH CLINIC</h1>
		...
		<div class="row ">
			<div class="col-lg-8">
				<div class="section-title">
					...
					<h2 class="mt-3 content-title">Hard work gonna pays off, choose our math clinic to be the best
					</h2>
				</div>
			</div>
		</div>
		<div class="row justify-content-center">
			<div class="col-lg-4 col-md-6 col-12">
				<div class="intro-item mb-5 mb-lg-0">
					...
					<h4 class="mt-4 mb-3">Choose your tutor</h4>
			...
			<div class="col-lg-4 col-md-6">
				<div class="intro-item mb-5 mb-lg-0">
					...
					<h4 class="mt-4 mb-3">Best materials</h4>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odit, ducimus.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-12">
				<div class="intro-item">
					...
					<h4 class="mt-4 mb-3">Online is the future</h4>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odit, ducimus.</p>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-7 text-center">
				<div class="section-title">
					<h2 class="mt-3 content-title text-white">We will brighten up your future in mathematics</h2>
				</div>
			</div>
		</div>
		...
		<div class="row justify-content-center">
			<div class="col-lg-4 col-md-6 mb-5">
				<div class="card bg-transparent border-0">
					<a href="#"><img loading="lazy" src="images/poster-2.png" alt="blog" class="img-fluid rounded"></a>
				</div>
			</div>

			<div class="col-lg-4 col-md-6 mb-5">
				<div class="card border-0 bg-transparent">
		<a href="#"><img loading="lazy" src="images/poster-4.png" alt="blog" class="img-fluid rounded"></a>
			...
			<div class="col-lg-4 col-md-6 mb-5">
				<div class="card border-0 bg-transparent">
			<a href="#"><img loading="lazy" src="images/poster-3.png" alt="blog" class="img-fluid rounded"></a>
				</div>
			</div>
		</div>
	</div>
...
<section class="section latest-blog bg-3">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-7 text-center">
				<div class="section-title">
					<h2 class="mt-3 content-title text-white">YOUR BEST ONLINE MATH TUITION</h2>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-6 offset-lg-6 offset-md-0">
				<div class="about-item ">
					<span class="h6 text-color">AVANTGARDE MATH CLINIC</span>
					<h2 class="mt-3 mb-4 position-relative content-title">FORM 1 - FORM 5<br>SYLLABUS</h2>
					<div class="about-content">
						<h4 class="mb-3 position-relative">With your preferred tutor</h4>
